...
tracks = [
  "./tracks/HarryStyles-WatermelonSugar.mp3",
  "./tracks/JustinBieber-Yummy.mp3",
  "./tracks/LoudLuxuryftBrando-Body.mp3",
];
thumbnails = [
  "./images/HarryStylesAlbumCover.jpg",
  "./images/JustinBieberSongCoverArt.jpg",
  "./images/LoudLuxurySongCoverArt.jpg",
];
